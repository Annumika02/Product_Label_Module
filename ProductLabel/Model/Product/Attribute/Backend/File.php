...
namespace Inventionstar\ProductLabel\Model\Product\Attribute\Backend;

use Magento\Framework\App\Filesystem\DirectoryList;

/**
 * Class File
 * @package Inventionstar\ProductLabel\Model\Product\Attribute\Backend
 */
...
class File extends \Magento\Eav\Model\Entity\Attribute\Backend\AbstractBackend
{
    ...
    {
        if ($this->request->getModuleName() != 'inventionstar_product_label') {
            $path = $this->_filesystem->getDirectoryRead(
                DirectoryList::MEDIA
            )->getAbsolutePath(
                'inventionstar/product_label_image/'
            );
