...
namespace Inventionstar\ProductLabel\Model\ResourceModel;
...
class ProductLabels extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    ...
    {
        $this->_init('inventionstar_product_label_rules', 'rule_id');
    }
    ...
    public function _afterSave(\Magento\Framework\Model\AbstractModel $object)
    {
        $this->saveData(
            $object,
            $this->getTable('inventionstar_product_label_rules_store'),
            'rule_id',
            'store_id'
        );
        $this->saveData(
            $object,
            $this->getTable('inventionstar_product_label_rules_customer_group'),
            'rule_id',
            'customer_group_id'
        );
