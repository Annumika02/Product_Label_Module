...
namespace Inventionstar\ProductLabel\Model\ResourceModel\ProductLabels;
...
class Collection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection
{
    ...
    {
        $this->_init(
            \Inventionstar\ProductLabel\Model\ProductLabels::class,
            \Inventionstar\ProductLabel\Model\ResourceModel\ProductLabels::class
        );
    }
    ...
    public function addStoreFilter($tabId)
    {
        ...
        $this->setMainTable('inventionstar_product_label_rules_store');
    ...
    {
        $this->getSelect()->reset(\Magento\Framework\DB\Select::WHERE);
        $this->setMainTable('inventionstar_product_label_rules_customer_group');
    ...
    public function _afterLoad()
    {
        ...
        if (count($linkedIds)) {
            $this->addData($this->getTable('inventionstar_product_label_rules_store'), 'store_id', $linkedIds, $linkField);
            $this->addData($this->getTable('inventionstar_product_label_rules_customer_group'), 'customer_group_id', $linkedIds, $linkField);
        }
